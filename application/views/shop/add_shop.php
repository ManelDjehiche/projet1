    ...
    <div>
        ...
        <div class="form-group">
            <div class="help-block with-errors"></div>
                ...
                <input class="au-btn au-btn-primary"  type = "file" name = "userfile" size = "20" value="upload" /> 
                <br /><br /> 
            </div>
        <div class="form-group">
        ...
        <input class="au-btn au-btn-primary" type="submit" name = "submit" id="submit" value="Confirm">
